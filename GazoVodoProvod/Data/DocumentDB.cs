...
public class DocumentDB
{
    ...
    public static List<DocumentType> FindDocumentTypes(Industries industries)
    {
        return documentTypeCollection.Find(x => x.Industry == industries).ToList();
    }

    public static List<DocumentType> FindDocumentTypesForProject(Industries industries, Roles role)
	{
		return documentTypeCollection.Find(x => x.Industry == industries).ToList();
	}
